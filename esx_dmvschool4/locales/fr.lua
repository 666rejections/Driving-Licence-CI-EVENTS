Locales['fr'] = {
  ...
  ['good_turn_right'] = '~g~Bien!~s~ prenez à ~y~droite~s~ et suivez votre file',
   ['good_turn_left'] = '~g~Bien!~s~ prenez à ~y~gauche~s~ et suivez votre file', 
  ...
  ['driving_school_blip'] = 'Permis Super-lourds',
  ...
  ['trailor'] = 'Allez sur le point pour prendre la remorque et attelez la au camion',
  ['trailor_end'] = 'Reposez la remoque ou continuez avec',
  ['permis'] = 'Vous devez avoir le permis voiture pour passer les permis du groupe lourds !',
}
